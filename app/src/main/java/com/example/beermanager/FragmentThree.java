...
public class FragmentThree extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        List<DayInfo> allDays = dataBaseHelper.getBadDays();

        if (!allDays.isEmpty()) {
            ListView lv_list = v.findViewById(R.id.framgent_bad_lv);
            ...
            Toast.makeText(mContext, "Historie je prázdná, nejsou žádné záznamy o neúspěších.", Toast.LENGTH_SHORT).show();
        return v;
