...
public class FragmentOne extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        List<DayInfo> allDays = dataBaseHelper.getAllDays();

        if (!allDays.isEmpty()) {
            ListView lv_list = v.findViewById(R.id.framgent_all_lv);
            ...
            Toast.makeText(mContext, "Historie je prázdná, nejsou žádné záznamy.", Toast.LENGTH_SHORT).show();
